...
<template>
  <div class="q-pa-sm">
    ...
    <q-separator inset style="height:0.2em"/>
      ...
      <q-card-section>
        Click <q-icon color="grey-7" name="sym_r_mark_chat_read"/> / <q-icon color="grey-7" name="sym_r_chat_bubble"/> Toggle Tooltips in the sidebar to show or hide hover-over help texts at various functions.
      </q-card-section>
    </q-card>
    ...
    <q-card>
      ...
      <q-card-section>
      You can access and edit the files in your ARC via the file tree.
