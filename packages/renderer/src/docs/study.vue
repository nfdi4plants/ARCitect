...
<template>
  <div class="q-pt-sm">
    ...
    <h5 style="margin-bottom:0.5em;">Study</h5>
    ...
    <q-card>
      ...
      <q-card-section>
        ...
        <q-list class="q-gutter-xs">
          <q-item>
            <q-item-section>
              In the people section you can add authors and collaborators of the study.
            </q-item-section>
          </q-item>
      ...
      <q-card-section>
        ...
        <q-list>
          <q-item>
            <q-item-section>
              In the publications section you can add publications to the study.
            </q-item-section>
          </q-item>
