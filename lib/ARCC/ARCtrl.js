...
export class ARC {
    constructor(isa, cwl, fs) {
        let fs_2;
        this["cwl@59"] = cwl;
        this["fs@60"] = ((fs_2 = ARCAux_updateFSByISA(isa, defaultArg(fs, FileSystem.create({
    ...
    TestSetFS() {
        const this$ = this;
        this$["fs@60"] = FileSystem.fromFilePaths([]);
    }
    UpdateFileSystem() {
        const this$ = this;
        let newFS;
        const fs = ARCAux_updateFSByISA(this$["isa@65"], this$["fs@60"]);
