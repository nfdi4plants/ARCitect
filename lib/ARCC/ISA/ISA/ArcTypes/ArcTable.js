...
import { Unchecked_extendToRowCount, ProcessParsing_processToRows, ProcessParsing_alignByHeaders, ProcessParsing_getProcessGetter, Unchecked_removeRowCells_withIndexChange, Unchecked_addRow, Unchecked_getEmptyCellForHeader, Unchecked_removeColumnCells_withIndexChange, tryFindDuplicateUniqueInArray, Unchecked_removeColumnCells, Unchecked_removeHeader, Unchecked_fillMissingCells, Unchecked_addColumn, tryFindDuplicateUnique, Unchecked_setCellAt, SanityChecks_validateColumn, SanityChecks_validateRowIndex, SanityChecks_validateColumnIndex, Unchecked_tryGetCellAt, getRowCount, getColumnCount } from "./ArcTableAux.js";
...
export class ArcTable extends Record {
    ...
    GetProtocols() {
        ...
        }, Protocol_create_Z7DFD6E67(void 0, this$.Name), this$.Headers)) : List_distinct(initialize_1(this$.RowCount, (i) => toProtocol(this$.Name, zip(this$.Headers, this$.GetRow(i)))), {
            Equals: equals,
    ...
    UpdateReferenceByAnnotationTable(table) {
        const this$ = this;
        Unchecked_extendToRowCount(table.RowCount, this$.Headers, this$.Values);
        const enumerator = getEnumerator(table.Columns);
        try {
            while (enumerator["System.Collections.IEnumerator.MoveNext"]()) {
                const c = enumerator["System.Collections.Generic.IEnumerator`1.get_Current"]();
                this$.AddColumn(c.Header, c.Cells, void 0, true);
            }
        }
        finally {
            disposeSafe(enumerator);
