...
export function OntologyAnnotation_decoder(options) {
    return (path_3) => ((v) => object_11((get$) => {
        let objectArg, objectArg_1, objectArg_2, objectArg_3, arg_9, decoder, objectArg_4;
        return OntologyAnnotation.create(unwrap((objectArg = get$.Optional, objectArg.Field("@id", uri))), unwrap((objectArg_1 = get$.Optional, objectArg_1.Field("annotationValue", (s_1, json_1) => AnnotationValue_decoder(options, s_1, json_1)))), unwrap((objectArg_2 = get$.Optional, objectArg_2.Field("termSource", string))), unwrap((objectArg_3 = get$.Optional, objectArg_3.Field("termAccession", string))), unwrap((arg_9 = ((decoder = decoder_1(options), (path_2) => ((value_2) => array(uncurry2(decoder), path_2, value_2)))), (objectArg_4 = get$.Optional, objectArg_4.Field("comments", uncurry2(arg_9))))));
    }, path_3, v));
}
