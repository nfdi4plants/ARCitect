...
export function fromString(lastName, firstName, midInitials, email, phone, fax, address, affiliation, role, rolesTermAccessionNumber, rolesTermSourceREF, comments) {
    ...
    let arg_12;
    const arg_2 = Option_fromValueWithDefault("", lastName);
    const arg_3 = Option_fromValueWithDefault("", firstName);
    const arg_4 = Option_fromValueWithDefault("", midInitials);
    const arg_5 = Option_fromValueWithDefault("", email);
    const arg_6 = Option_fromValueWithDefault("", phone);
    const arg_7 = Option_fromValueWithDefault("", fax);
    const arg_8 = Option_fromValueWithDefault("", address);
    const arg_9 = Option_fromValueWithDefault("", affiliation);
    const arg_10 = Option_fromValueWithDefault([], roles);
    const arg_11 = Option_fromValueWithDefault([], comments);
    arg_12 = Person.make(void 0, void 0, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, arg_11);
