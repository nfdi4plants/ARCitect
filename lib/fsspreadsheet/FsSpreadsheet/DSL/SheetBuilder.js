...
export function SheetBuilder_$reflection() {
    return class_type("FsSpreadsheet.DSL.SheetBuilder", void 0, SheetBuilder);
}

export function SheetBuilder_$ctor_Z721C83C5(name) {
    return new SheetBuilder(name);
}

export function SheetBuilder_get_Empty() {
    return SheetEntity$1_some_2B595(empty());
}

export function SheetBuilder__SignMessages_3F89FFFC(this$, messages) {
    return map((m) => {
        let clo_1;
...
export function SheetBuilder__Run_5EFE5A35(this$, children) {
    switch (children.tag) {
        case 1:
...
export function SheetBuilder__Combine_6037FAE0(this$, wx1, wx2) {
